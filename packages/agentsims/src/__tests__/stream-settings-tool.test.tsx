...
import { AndroidSimulatorSettingsTool } from "../web/components/android-simulator-settings-tool";
import {
  StreamFrameRateHistory,
  StreamSettingsTool,
} from "../web/components/stream-settings-tool";
...
describe("simulator stream history", () => {
  test("renders themed native FPS history and its definition", () => {
    ...
    const html = renderToStaticMarkup(<StreamFrameRateHistory frameRate={frameRate} />);
