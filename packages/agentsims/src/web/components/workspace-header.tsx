      ...
      <footer className="pointer-events-none fixed inset-x-3 bottom-3 z-50 flex justify-center font-system">
        ...
        >
          <motion.div
            ...
            transition={{ duration: expanded ? 0.1 : 0.07, delay: expanded ? 0.015 : 0 }}
              ...
              {pickerOpen ? (
                ...
                >
                  <div className="flex h-11 shrink-0 items-center justify-between border-b border-white/[0.07] px-3">
                    <span className="text-[12px] font-medium text-white/75">Devices</span>
          ...
          >
            ...
            >
              <MonitorSmartphone size={17} strokeWidth={1.9} className="shrink-0" />
            </WorkspaceDockButton>
            <WorkspaceDockButton
              onClick={onToggleTools}
