...
import { usePrefersMoreContrast } from "../../hooks/simulator/use-prefers-more-contrast";
import { usePrefersReducedMotion } from "../../hooks/simulator/use-prefers-reduced-motion";
import {
	RESIZE_MAIN_STROKE,
...
export function SimulatorResizeCornerSvg({
	...
	const scaleEase =
		isHot && supportsLinearEasing() ? SIMULATOR_RESIZE_SPRING : ease;
	const motionTransform = reducedMotion
		? "none"
		: `transform ${dur} ${scaleEase}`;
