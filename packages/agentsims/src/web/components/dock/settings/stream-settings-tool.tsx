...
import type { SimulatorFrameRateStore } from "../../../simulator/stream/simulator-frame-rate";
...
export function StreamFrameRateHistory({
	frameRate,
}: {
			...
			<div className="flex flex-col gap-1.5 pb-1.5">
				...
				{frameRate && open && (
					<div
						className={
							showCodecControls
								? "mt-1 border-t border-white/[0.06] pt-2.5"
								: ""
						}
					>
