...
export const SIMULATOR_RESIZE_PAGE_TRANSITION =
	"padding-right 0.24s cubic-bezier(0.22, 1, 0.36, 1)";
...
export type SimulatorResizeArc = {
	d: string;
	dFill: string;
	viewBoxSize: number;
};
...
export function supportsLinearEasing(): boolean {
	...
	if (typeof CSS === "undefined" || typeof CSS.supports !== "function")
		return false;
	supportsLinearEasingCache = CSS.supports(
...
export const SIMULATOR_RESIZE_SCALE_STORAGE_KEY =
	"agentsims:simulator-frame-scale";
