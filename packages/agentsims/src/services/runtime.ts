...
export class ShellExec extends Context.Tag("@agentsims/ShellExec")<ShellExec, ShellExecService>() {}

export const ShellExecLive = Layer.effect(ShellExec, Effect.gen(function*() {
